// RAL.cpp : This file contains the 'main' function. Program execution begins and ends there.
...
int main() {
    ...
    while (1) {
        ...
        while(1){
            ...
            cin >> funkcia;
            cin.clear(0);
            if ( (funkcia < 0) || (predmet==1 && funkcia>11) || (predmet==2 && funkcia>8) || (predmet==3 && funkcia>8) ) {
                WRONG_INPUT();
                continue;
            }
